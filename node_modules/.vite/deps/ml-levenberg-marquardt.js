...
// node_modules/ml-levenberg-marquardt/lib-esm/checkOptions.js
init_lib_esm();
function checkOptions(data, parameterizedFunction, options) {
  let { timeout, minValues, maxValues, initialValues, weights = 1, damping = 0.01, dampingStepUp = 11, dampingStepDown = 9, maxIterations = 100, errorTolerance = 1e-7, centralDifference = false, gradientDifference = 0.1, improvementThreshold = 1e-3 } = options;
  if (damping <= 0) {
  ...
  if (timeout !== void 0) {
    ...
    let endTime = Date.now() + timeout * 1e3;
...
// node_modules/ml-levenberg-marquardt/lib-esm/errorCalculation.js
...
// node_modules/ml-levenberg-marquardt/lib-esm/step.js
function matrixFunction(data, evaluatedData) {
  const m = data.x.length;
  let ans = new Matrix2(m, 1);
...
function step(data, params, damping, gradientDifference, parameterizedFunction, centralDifference, weights) {
  ...
  let inverseMatrix = inverse2(identity.add(gradientFunc.mmul(gradientFunc.transpose().scale("row", { scale: weights }))));
...
// node_modules/ml-levenberg-marquardt/lib-esm/index.js
...
//# sourceMappingURL=ml-levenberg-marquardt.js.map
